<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasMenu" aria-labelledby="offcanvasMenuLabel">
    ...
    <div class="offcanvas-body">
      <div class="side-menu-profile">
        <img src="https://edufyacademy.com/assets/images/logo/logo.png" alt="Profile Picture" 
     style="width: 30%; height: auto; object-fit: contain;">

        <h6>Edufy Academy</h6>
        <p>info@edufyacademy.com</p>
      </div>
      <nav class="nav flex-column mt-2">
        <a class="nav-link" href="home.php"><i class="fa fa-home me-2"></i>Home</a>
